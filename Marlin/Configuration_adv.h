...
#endif // if ENABLED(TOUCH_UI_FTDI_EVE)
...
#define LIN_ADVANCE
  ...
  #else
    #define ADVANCE_K 1.0         // (mm) Compression length applying to all extruders
  #endif
...
#endif // if ENABLED(ADVANCED_PAUSE_FEATURE)
 ...
 */
  ...
  #define INTERPOLATE      true
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT         1130      // (mA) RMS current. Multiply by 1.414 for peak current.
    ...
    // #define E1_INTERPOLATE    Z2_INTERPOLATE
...
// #define SPINDLE_FEATURE
  ...
  #endif // if ENABLED(SPINDLE_FEATURE)
